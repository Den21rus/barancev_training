...
class test_add_group(unittest.TestCase):
    ...
    def test_test_add_group(self):
        ...
        wd.find_element_by_name("login_field").click()
        wd.find_element_by_name("login_field").clear()
        wd.find_element_by_name("login_field").send_keys("Den21rus")
        wd.find_element_by_name("password").click()
        wd.find_element_by_name("password").clear()
        wd.find_element_by_name("password").send_keys("Htc777@pux")
